...
<html>
    ...
    <body>
        ...
        <div id="show-diretor" class="content scaffold-show" role="main">
            ...
            <f:display bean="diretor" />
            <g:form resource="${this.diretor}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.diretor}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
