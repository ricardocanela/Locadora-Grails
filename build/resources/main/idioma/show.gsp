...
<html>
    ...
    <body>
        ...
        <div id="show-idioma" class="content scaffold-show" role="main">
            ...
            <f:display bean="idioma" />
            <g:form resource="${this.idioma}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.idioma}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
