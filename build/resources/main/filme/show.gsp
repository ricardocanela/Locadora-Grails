...
<html>
    ...
    <body>
        ...
        <div id="show-filme" class="content scaffold-show" role="main">
            ...
            <f:display bean="filme" />
            <g:form resource="${this.filme}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.filme}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
